...
{
	if (BounceSound != nullptr && NormalImpulse.Size() > 1200.0f)
	{
		UGameplayStatics::PlaySoundAtLocation(this, BounceSound, GetActorLocation(), 1.0f, FMath::RandRange(0.7f, 1.2f), 0.0f, BounceSoundAttenuation);
	}
	...
	if (Player != nullptr)
	{
		...
		{
			HealthComponent->LooseHealth(Damage);
		}
